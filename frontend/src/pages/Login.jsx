                    ...
                    <div className="w-full max-w-md space-y-6">
                        <div className="w-full max-w-sm bg-white/5 backdrop-blur-lg rounded-xl border border-white/10 shadow-2xl">
                            <div className="p-6 pb-4 space-y-2">
                                ...
                                <p className="text-sm text-gray-400 text-center">Login — Join us and start your journey</p>
                            ...
                            <div className="px-6 pb-4">
                                <div className="flex flex-col gap-5">
                                    ...
                                    <div className="flex justify-end">
                                        <button
                                            type="button"
                                            className="text-sm text-blue-400 hover:text-blue-300 cursor-pointer transition-colors duration-200"
                            ...
                            <div className="p-6 pt-4 flex flex-col gap-4">
                                ...
                                <p className="text-xs text-center text-gray-500">
                                    ...
                                    <button
                                        type="button"
                                        className="text-blue-400 hover:text-blue-300 cursor-pointer ml-1 transition-colors duration-200"
